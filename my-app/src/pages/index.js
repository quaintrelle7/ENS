...
export default function Home(){
   ...
   *
   * A `Signer` is a special type of Provider used in case a 
   * `write` transaction needs to be made to the blockchain, which involves the connected account
...
/*
  ...
  */
  ...
  useEffect(()=>{
    ...
    if(!walletConnected){
      // Assign the Web3Modal class to the
      //  reference object by setting it's `current` value
      // The `current` value is persisted throughout
